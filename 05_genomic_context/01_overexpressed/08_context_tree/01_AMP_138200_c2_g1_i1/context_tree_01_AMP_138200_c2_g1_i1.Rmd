...
list(file = "./CP107195.1.gff3", species_name = "Bacteroides xylanisolvens isolate KR001_HAM_0012 chromosome", start = 3408922, end = 3428179),
list(file = "./CP046426.1.gff3", species_name = "Phocaeicola dorei strain JR03 chromosome", start = 1620382, end = 1639639),
list(file = "./CP046424.1.gff3", species_name = "Phocaeicola dorei strain JR01 chromosome", start = 1741737, end = 1760994),
list(file = "./CP103166.1.gff3", species_name = "Bacteroides caccae strain BFG-474 chromosome", start = 4947199, end = 4967942),
list(file = "./AP019724.1.gff3", species_name = "Bacteroides uniformis NBRC 113350 DNA", start = 978001, end = 997258),

list(file = "./CP046425.1.gff3", species_name = "Phocaeicola dorei strain JR02 chromosome", start = 1621416, end = 1640673),
list(file = "./CP103125.1.gff3", species_name = "Bacteroides faecis strain BFG-493 chromosome", start = 5382741, end = 5401998),
list(file = "./CP083675.1.gff3", species_name = "Bacteroides salyersiae strain WAL7960 chromosome", start = 208409, end = 227666),
list(file = "./CP083680.1.gff3", species_name = "Bacteroides thetaiotaomicron strain WAL8669 chromosome", start = 5740504, end = 5761247),
list(file = "./CP126057.1.gff3", species_name = "Phocaeicola dorei strain 2 plasmid unnamed", start = 62152, end = 80844)
)

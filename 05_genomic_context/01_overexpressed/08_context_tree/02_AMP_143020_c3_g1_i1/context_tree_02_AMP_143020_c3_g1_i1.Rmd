...
gff3_files_info <- list(
  list(file = "./CP014223.1.gff3", species_name = "Anaerotignum propionicum DSM 1682", start = 2491741, end = 2502093),
  list(file = "./CP133078.1.gff3", species_name = "Anaerotignum sp. MB30-C6 chromosome", start = 2472315, end = 2482669),
  list(file = "./BK058526.1.gff3", species_name = "Caudoviricetes sp. isolate ctzDR1", start = 10016, end = 20374),
  list(file = "./BK026787.1.gff3", species_name = "Caudoviricetes sp. isolate ctJ1L4", start = 14543, end = 24898)
)

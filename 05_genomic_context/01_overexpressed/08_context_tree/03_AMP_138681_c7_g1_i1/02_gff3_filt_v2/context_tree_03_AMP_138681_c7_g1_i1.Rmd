...
## Genomic context AMP_138681_c7_g1_i1
...
gff3_files_info <- list(
  ...
  list(file = "./BK033981.1.fasta_filtered_prodigal.pep_dmnd.outfmt6.final.gff3", species_name = "Caudoviricetes sp. isolate ctiL05", start = 8506, end = 14519),
  list(file = "./BK025808.1.fasta_filtered_prodigal.pep_dmnd.outfmt6.final.gff3", species_name = "Caudoviricetes sp. isolate ctvmC44", start = 0, end = 10462),
  list(file = "./BK026979.1.fasta_filtered_prodigal.pep_dmnd.outfmt6.final.gff3", species_name = "Caudoviricetes sp. isolate ctInE22", start = 0, end = 10462),
  list(file = "./BK027835.1.fasta_filtered_prodigal.pep_dmnd.outfmt6.final.gff3", species_name = "Caudoviricetes sp. isolate ctUyu4", start = 5140, end = 16000),
  list(file = "./CP107216.1.fasta_filtered_prodigal.pep_dmnd.outfmt6.final.gff3", species_name = "Clostridiales bacterium isolate KR001_HIC_0007", start = 2203911, end = 2224257),
  list(file = "./BK038133.1.fasta_filtered_prodigal.pep_dmnd.outfmt6.final.gff3", species_name = "Caudoviricetes sp. isolate ctlNO7", start = 0, end = 10463)
